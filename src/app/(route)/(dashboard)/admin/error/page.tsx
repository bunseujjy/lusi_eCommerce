const Error = () => {
  return (
    <div className="bg-white dark:bg-transparent px-10 my-20">
      <div className="container">
        <div className="flex w-full rounded-lg border-l-[6px] border-red-600 bg-red-300 px-7 py-8 shadow-[0px_2px_10px_0px_rgba(0,0,0,0.08)] md:p-9">
          ...
          <div className="w-full">
            ...
            <ul className="list-inside list-disc">
              <li className="text-base leading-relaxed text-red-600 dark:text-red-700">
                You need to be an <span className="font-semibold">ADMIN</span>{" "}
