...
import DeleteButton from "@/app/components/Button/DeleteProductButton";
...
export const generateMetadata = ({ params }: Props): Metadata => {
  return {
    title: `Delete products ${params.id}`,
    description: `Delete products ${params.id}`,
  };
};
            ...
            <div className="mx-auto overflow-hidden rounded-lg bg-white shadow-xl sm:w-full sm:max-w-xl">
              <div className="relative p-6 dark:bg-navy-800">
                ...
                <div className="mt-6 flex justify-end gap-3">
                  <DeleteButton product={JSON.parse(JSON.stringify(product))} />
                </div>
              </div>
            </div>
          </div>
