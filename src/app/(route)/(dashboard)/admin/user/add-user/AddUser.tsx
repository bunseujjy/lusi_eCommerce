  ...
  return (
    ...
    >
      <div className="py-4 w-full h-full md:h-auto">
        <div className=" w-full relative p-4 bg-white rounded-lg shadow dark:bg-navy-700 sm:p-5">
          ...
          <form action="#">
            ...
            <div>
              <div className="my-7 flex flex-wrap gap-1">
                <div
                  className={`${
                    profileImg
            ...
            <button
              ...
              type="submit"
              className="bg-cyan-500 text-white dark:bg-brand-300 dark:hover:bg-brand-200 px-4 py-2  rounded-md"
            >
