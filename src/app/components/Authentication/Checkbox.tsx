  ...
  return (
    <input
      ...
      className={`defaultCheckbox relative flex h-[20px] min-h-[20px] w-[20px] min-w-[20px] appearance-none items-center 
        justify-center rounded-md border border-gray-300 text-white outline-none transition duration-&lsqb;0.2s&rsqb
        checked:border-none checked:text-white hover:cursor-pointer dark:border-white/10 ${
          color === "red"
            ...
            : "checked:bg-[#422AFB] dark:checked:bg-brand-400"
        } ${extra}`}
      {...rest}
    />
  );
